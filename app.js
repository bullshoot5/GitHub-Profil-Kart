...
//sayfa içerisindeki elemanları alıyoruz.
const form = document.getElementById('form');
const search = document.getElementById('search');
const main = document.getElementById('main');
//asenkron function tanımlanıyor.
...
//alinan verilere göre html de card divi oluşturuyoruz.
...
//aranılan değerle alakalı sonuç çıkmazsa hata cartı oluşturuluyor.
